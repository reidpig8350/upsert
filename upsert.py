...
with open("./which_row.txt", "w", encoding="utf-8") as which_row:
    ...
    for i in sheet_keys:
        ...
        which_row.write("{sheet_key_counts}/{sheet_key_length} " .format(sheet_key_counts=sheet_key_counts, sheet_key_length=len(sheet_keys)) + file_name + " {row_start}-{row_end}\n" .format(row_start=row_start, row_end=sheet_row_counts))
        print("{sheet_key_counts}/{sheet_key_length}" .format(sheet_key_counts=sheet_key_counts, sheet_key_length=len(sheet_keys)), file_name, "{row_start}-{row_end}" .format(row_start=row_start, row_end=sheet_row_counts))
